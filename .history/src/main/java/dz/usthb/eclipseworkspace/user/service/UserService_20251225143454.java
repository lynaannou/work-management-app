...
public class UserService {
    ...
    public List<User> searchUsersByEmail(String prefix) throws SQLException {
    return userDao.searchByEmailPrefix(prefix, 10);
}
// ======================================
// REGISTRATION (PUBLIC)
// ======================================
...
public User register(
    ...
    // Hash password
    String passwordHash = passwordHashStrategy.hashPassword(password);
